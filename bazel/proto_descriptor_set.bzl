...
TODO: This file is imported from rules_proto. Although rules_proto is deprecated
and the functionality has been moved into the protobuf repo,
`proto_descriptor_set` has not (yet) been moved:

https://github.com/protocolbuffers/protobuf/pull/23369

Once we move to a new version of protobuf that includes this change, we can get
rid of this file.
"""
...
""".strip(),
        ...
        "_file_concat": attr.label(
            default = "//bazel/tools/file_concat",
            executable = True,
            cfg = "exec",
        ),
    },
