...
load(
    "@com_github_reboot_dev_reboot//rebootdev:rules.bzl",
    "js_proto_library",
...
pydantic_to_proto = rule(
    ...
    attrs = {
        ...
        "_pydantic_to_proto_binary": attr.label(
            default = Label("@com_github_reboot_dev_reboot//rebootdev:pydantic_to_proto"),
            executable = True,
            cfg = "exec",
        ),
    },
...
pydantic_to_zod = rule(
    ...
    attrs = {
        ...
        "_pydantic_to_zod_binary": attr.label(
            default = Label("@com_github_reboot_dev_reboot//rebootdev:pydantic_to_zod"),
            executable = True,
            cfg = "exec",
        ),
    },
