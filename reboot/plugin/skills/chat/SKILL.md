...
# /chat — Build Reboot AI Chat Apps
...
13. **STOP.** Do NOT run the app yourself. Print the following run
    ...
    `mcp_servers.json`. Print the real absolute path. Then suggest a
    first prompt the user can try in the inspector (e.g., "Create a
