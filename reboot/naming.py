...
#     hostname labels.
SpaceId: TypeAlias = reboot.aio.types.SpaceId
# An application ID has the same format as a space ID, but starts with "a".
ApplicationId: TypeAlias = reboot.aio.types.ApplicationId
...
ServerId: TypeAlias = reboot.aio.types.ServerId
...
ShardId: TypeAlias = reboot.aio.types.ShardId
