...
def py_reboot_library(
    ...
    py_library(
        ...
        deps = [
            ...
            "@com_github_reboot_dev_reboot//reboot/aio:headers_py",
            "@com_github_reboot_dev_reboot//reboot/aio:idempotency_py",
            "@com_github_reboot_dev_reboot//reboot/aio:placement_py",
            "@com_github_reboot_dev_reboot//reboot/aio:servicers_py",
...
def _js_proto_files(
    ...
    native.genrule(
        ...
        cmd_bash = """
            ...
            if [[ "$$proto_path" == bazel-out/* ]]; then
              ...
              $(execpath @com_google_protobuf//:protoc) \\
                --plugin=protoc-gen-es=$(execpath //reboot:protoc-gen-es_with_deps) \\
        ...
        tools = [
            "//reboot:protoc-gen-es_with_deps",
...
_py_boilerplate_reboot_files = create_protoc_plugin_rule(
    "@com_github_reboot_dev_reboot//reboot:protoc-gen-reboot_python_boilerplate",
