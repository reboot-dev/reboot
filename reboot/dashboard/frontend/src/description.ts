...
// One row of a type, as the page draws it. A row whose type is
// another object carries `link`, the id of the data object it holds,
// rather than that object's own rows: one level deep, and the rest is
// a click away.
