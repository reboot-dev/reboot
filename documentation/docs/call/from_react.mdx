...
See [Web apps](/surfaces/web#signing-in) for the browser flow, and
[React Native apps](/surfaces/react_native) for the native one.

## In AI chat UIs

The same generated hooks work unchanged inside an
[AI chat client](/surfaces/ai_chat), where a
[`UI` method](/surfaces/ui_methods) renders your component. A few
things differ:

- **No `url` prop needed.** In the AI chat context,
  `RebootClientProvider` automatically detects the environment.
  You do not pass a `url`:

<!-- MARKDOWN-AUTO-DOCS:START
(CODE:src=../../../reboot/examples/ai-chat-counter/frontend/mcp/clicker/main.tsx&lines=9-11) -->
...
- **Automatic ID resolution.** For `User` methods, the hook
  ...
  [`UI` methods](/surfaces/ui_methods) for a complete
  component):

<!-- MARKDOWN-AUTO-DOCS:START
(CODE:src=../../../reboot/examples/ai-chat-counter/frontend/mcp/clicker/App.tsx&lines=10-31) -->
...
<!-- MARKDOWN-AUTO-DOCS:START
(CODE:src=../../../reboot/examples/ai-chat-counter-dashboard/frontend/mcp/dashboard/App.tsx&lines=20-21) -->
<!-- The below code snippet is automatically added from ../../../reboot/examples/ai-chat-counter-dashboard/frontend/mcp/dashboard/App.tsx -->
...
This line calls the
[`writer`](/define/methods#kinds) method, declared
