...
| `rbt dashboard` | Serve the developer dashboard, which watches your API directory and your [feature files](/features) as you write them, and open it in your browser. Needs the `reboot[dev]` extra installed. |
