...
| `UI` | `UI` methods declare a React component to display in the AI chat interface. The React `App.tsx` is the implementation; there is no backend servicer code. When the AI calls the associated tool, the chat client opens the React app. See [UI methods](/surfaces/ui_methods). |

## Exposing methods to an AI

Every method is callable from your own code, from a
[web](/surfaces/web) or [React Native](/surfaces/react_native)
