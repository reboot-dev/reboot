...
| `UI` | `UI` methods declare a React component to display in the AI chat interface. The React `App.tsx` is the implementation; there is no backend servicer code. When the AI calls the associated tool, the chat client opens the React app. See [UI methods](/frontends/ui_methods). |
