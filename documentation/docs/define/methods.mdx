...
An existing flow chart about method kinds that could serve as a template: https://docs.google.com/presentation/d/10NpT5dixaa_DLYRtRajYr1heRNpoBkn6pPId0AmlAWw/edit#slide=id.g238161c3009_0_780 -->
...
| `UI` | `UI` methods declare a React component to display inside an MCP client. The React `App.tsx` is the implementation; there is no backend servicer code. When the AI calls the associated tool, the MCP client opens the React app. See [UI methods](/frontends/ui_methods). |

## Exposing methods to an AI

Every method is callable from your own code, from a
[web](/frontends/web) or [React Native](/frontends/react_native)
frontend, and from anywhere else you have a client. Whether an **AI**
may call it is a separate, explicit decision.

When you define your API with [Pydantic](/define/pydantic), every
...
[Creating tools](/define/pydantic#creating-tools-for-the-ai) and
