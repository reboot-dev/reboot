...
3. **Default authorization**: `User` methods are accessible to
   ...
   See [Default authorizer](/users/authorization#default-authorizer)
   for details.
...
Depending on its [kind](/define/methods), a method
...
[`UI`](/surfaces/ui_methods) methods.
...
see [Implement your API](/implement/servicers).
