...
<!-- MARKDOWN-AUTO-DOCS:START (CODE:src=../../../reboot/examples/mcp-ui-counter/backend/src/servicers/counter.py&lines=72-84&syntax=python) -->
<!-- The below code snippet is automatically added from ../../../reboot/examples/mcp-ui-counter/backend/src/servicers/counter.py -->
...
<!-- MARKDOWN-AUTO-DOCS:START (CODE:src=../../../reboot/examples/mcp-ui-counter/backend/src/servicers/counter.py&lines=20-33&syntax=python) -->
<!-- The below code snippet is automatically added from ../../../reboot/examples/mcp-ui-counter/backend/src/servicers/counter.py -->
