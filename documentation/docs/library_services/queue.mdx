...
<!-- MARKDOWN-AUTO-DOCS:END -->
  ...
  <TabItem value="typescript" label="TypeScript">
<!-- MARKDOWN-AUTO-DOCS:START
(CODE:src=../../../../tests/reboot/std/collections/queue/v1/queue_tests.ts&lines=65-66) -->
<!-- The below code snippet is automatically added from ../../../../tests/reboot/std/collections/queue/v1/queue_tests.ts -->
```ts
...
<!-- MARKDOWN-AUTO-DOCS:END -->
  ...
  <TabItem value="typescript" label="TypeScript">
<!-- MARKDOWN-AUTO-DOCS:START
(CODE:src=../../../../tests/reboot/std/collections/queue/v1/queue_tests.ts&lines=1-1) -->
<!-- The below code snippet is automatically added from ../../../../tests/reboot/std/collections/queue/v1/queue_tests.ts -->
```ts
...
<!-- MARKDOWN-AUTO-DOCS:END -->
<!-- MARKDOWN-AUTO-DOCS:START
(CODE:src=../../../../tests/reboot/std/collections/queue/v1/queue_tests.ts&lines=77-87) -->
<!-- The below code snippet is automatically added from ../../../../tests/reboot/std/collections/queue/v1/queue_tests.ts -->
```ts
...
<!-- MARKDOWN-AUTO-DOCS:END -->
  ...
  <TabItem value="typescript" label="TypeScript">
<!-- MARKDOWN-AUTO-DOCS:START
(CODE:src=../../../../tests/reboot/std/collections/queue/v1/queue_tests.ts&lines=89-96) -->
<!-- The below code snippet is automatically added from ../../../../tests/reboot/std/collections/queue/v1/queue_tests.ts -->
```ts
