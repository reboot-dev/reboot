...
started with Claude Code](/ai_chat_apps/get_started_claude_code) guide. If you want to use **Codex**
to build your app, see the [getting started with Codex](/ai_chat_apps/get_started_codex) guide.
...
<!-- MARKDOWN-AUTO-DOCS:START (CODE:src=../../../tests/reboot/documentation/backend/src/main.py&syntax=python) -->
<!-- The below code snippet is automatically added from ../../../tests/reboot/documentation/backend/src/main.py -->
...
<!-- MARKDOWN-AUTO-DOCS:START (CODE:src=../../../tests/reboot/documentation/get_started_main.tsx&syntax=tsx) -->
<!-- The below code snippet is automatically added from ../../../tests/reboot/documentation/get_started_main.tsx -->
...
* **[UIs for AI Chat Apps](/surfaces/ui_methods)** — the
