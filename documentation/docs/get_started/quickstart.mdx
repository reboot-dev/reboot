...
started with Claude Code](/get_started/claude_code) guide. If you want to use **Codex**
to build your app, see the [getting started with Codex](/get_started/codex) guide.
...
* **[AI Chat App Examples](/get_started/examples)**
