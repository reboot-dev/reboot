...
agents inside Reboot [workflows](/learn_more/implement/workflows) with
...
- **Every tool call** -- whether registered via `@agent.tool`, passed
  as `tools=`, or contributed via `toolsets=` -- is memoized too,
...
- **Streaming runs are drained inside a memoized block.** Even on
  the first run, events arrive in a single batch once the model call
  finishes. The `StreamedRunResult` you get back is backed by a
  fully-stored response; iteration replays the stored events instead
  of re-streaming from the provider. Live token-by-token streaming
  is fundamentally incompatible with replay.
...
(CODE:src=../../../tests/reboot/documentation/agents_examples.py&lines=19-23) -->
<!-- The below code snippet is automatically added from ../../../tests/reboot/documentation/agents_examples.py -->
...
<!-- MARKDOWN-AUTO-DOCS:START
(CODE:src=../../../tests/reboot/documentation/agents_examples.py&lines=25-26) -->
<!-- The below code snippet is automatically added from ../../../tests/reboot/documentation/agents_examples.py -->
...
<!-- MARKDOWN-AUTO-DOCS:START
(CODE:src=../../../tests/reboot/documentation/agents_examples.py&lines=63-70) -->
<!-- The below code snippet is automatically added from ../../../tests/reboot/documentation/agents_examples.py -->
...
<!-- MARKDOWN-AUTO-DOCS:START
(CODE:src=../../../tests/reboot/documentation/agents_examples.py&lines=74-79) -->
<!-- The below code snippet is automatically added from ../../../tests/reboot/documentation/agents_examples.py -->
...
<!-- MARKDOWN-AUTO-DOCS:START
(CODE:src=../../../tests/reboot/documentation/agents_examples.py&lines=29-58) -->
<!-- The below code snippet is automatically added from ../../../tests/reboot/documentation/agents_examples.py -->
...
<!-- MARKDOWN-AUTO-DOCS:START
(CODE:src=../../../tests/reboot/documentation/agents_examples.py&lines=127-135) -->
<!-- The below code snippet is automatically added from ../../../tests/reboot/documentation/agents_examples.py -->
...
<!-- MARKDOWN-AUTO-DOCS:START
(CODE:src=../../../tests/reboot/documentation/agents_examples.py&lines=90-117) -->
<!-- The below code snippet is automatically added from ../../../tests/reboot/documentation/agents_examples.py -->
...
<!-- MARKDOWN-AUTO-DOCS:START
(CODE:src=../../../tests/reboot/documentation/agents_examples.py&lines=137-141) -->
<!-- The below code snippet is automatically added from ../../../tests/reboot/documentation/agents_examples.py -->
...
<!-- MARKDOWN-AUTO-DOCS:START
(CODE:src=../../../tests/reboot/documentation/agents_examples.py&lines=121-122) -->
<!-- The below code snippet is automatically added from ../../../tests/reboot/documentation/agents_examples.py -->
...
- **Reboot workflows** retry the entire method body when an
  ...
  retry policy).
- **Reboot's `at_least_once`** already gets your block retried:
  every workflow retry gives an unfinished block another attempt
  until it succeeds, while blocks that succeeded are never re-run.
  You don't need retry logic inside the block itself.
...
- **Pydantic AI builtin tools** (web search, code execution,
  ...
  call/return parts are baked into the `ModelResponse` that Reboot
  already memoizes. They're durable for free.
...
- **Tool side-effects you didn't wrap.** Reboot's wrapping
  ...
  -- see the `stripe_create_invoice` example above.
...
- Calling Reboot's entry points through an `AbstractAgent`-typed
  reference will fail with a `UserError` naming the fix: Reboot's
