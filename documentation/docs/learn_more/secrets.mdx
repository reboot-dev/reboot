...
API key (see
[Create an API key](/deploy_on_reboot_cloud#create-an-api-key)):
...
In tests, set the environment variable before starting the
[Reboot test harness](/learn_more/testing):
