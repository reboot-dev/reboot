...
<!-- MARKDOWN-AUTO-DOCS:START
(CODE:src=../../../../reboot/examples/chat-room/api/chat_room/v1/chat_room.proto&&lines=9-50&syntax=protobuf) -->
...
- **Automatic ID resolution.** For `User` methods, the hook
  ...
  [`UI` methods](/learn_more/implement/ui_methods) for a complete
  component):
