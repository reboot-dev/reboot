...
"External" to a Reboot application means from a (micro)service
...
(CODE:src=../../../../tests/reboot/documentation/test_chat_room.py&lines=28-35) -->
<!-- The below code snippet is automatically added from ../../../../tests/reboot/documentation/test_chat_room.py -->
...
<!-- MARKDOWN-AUTO-DOCS:START
(CODE:src=../../../../tests/reboot/documentation/chat_room.ts&lines=54-63) -->
...
You can make calls [`idempotently()`](/learn_more/idempotency)
...
<Tabs groupId="language">
  <TabItem value="python" label="Python" default>
<!-- MARKDOWN-AUTO-DOCS:START
(CODE:src=../../../../tests/reboot/documentation/test_chat_room.py&lines=42-46) -->
<!-- The below code snippet is automatically added from ../../../../tests/reboot/documentation/test_chat_room.py -->
...
<!-- MARKDOWN-AUTO-DOCS:END -->
  ...
  <TabItem value="typescript" label="TypeScript">
<!-- MARKDOWN-AUTO-DOCS:START
(CODE:src=../../../../tests/reboot/documentation/chat_room.ts&lines=74-78) -->
<!-- The below code snippet is automatically added from ../../../../tests/reboot/documentation/chat_room.ts -->
...
[Making concurrent calls](/learn_more/call/from_within_your_app#making-concurrent-calls).
For Python, the `concurrently` helper provides adaptive
concurrency limits and streaming results — see
[`concurrently` (Python)](/learn_more/call/from_within_your_app#concurrently-python)
