...
create other state types. Methods with `mcp=Tool()` become
...
(CODE:src=../../../../tests/reboot/documentation/mcp_tools_pydantic.py&lines=30-74) -->
<!-- The below code snippet is automatically added from ../../../../tests/reboot/documentation/mcp_tools_pydantic.py -->
...
<!-- MARKDOWN-AUTO-DOCS:START
(CODE:src=../../../../tests/reboot/documentation/tool_options_pydantic.py&lines=17-22) -->
<!-- The below code snippet is automatically added from ../../../../tests/reboot/documentation/tool_options_pydantic.py -->
