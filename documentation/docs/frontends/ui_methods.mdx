...
<!-- MARKDOWN-AUTO-DOCS:START (CODE:src=../../../reboot/examples/mcp-ui-counter-dashboard/api/mcp_ui_counter/v1/counter.py&lines=88-94&syntax=python) -->
...
<!-- MARKDOWN-AUTO-DOCS:START (CODE:src=../../../reboot/examples/mcp-ui-counter/api/mcp_ui_counter/v1/counter.py&lines=92-98&syntax=python) -->
...
<!-- MARKDOWN-AUTO-DOCS:START (CODE:src=../../../reboot/examples/mcp-ui-counter-dashboard/api/mcp_ui_counter/v1/counter.py&lines=95-102&syntax=python) -->
<!-- The below code snippet is automatically added from ../../../reboot/examples/mcp-ui-counter-dashboard/api/mcp_ui_counter/v1/counter.py -->
