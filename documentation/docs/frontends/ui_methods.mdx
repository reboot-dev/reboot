...
[MCP client](/frontends/mcp_ui) opens inside the conversation when
...
:::info MCP UIs only
`UI` methods exist for [MCP](/frontends/mcp_ui), where they appear as
...
<!-- MARKDOWN-AUTO-DOCS:START (CODE:src=../../../reboot/examples/mcp-ui-counter-dashboard/api/mcp_ui_counter/v1/counter.py&lines=90-96&syntax=python) -->
<!-- The below code snippet is automatically added from ../../../reboot/examples/mcp-ui-counter-dashboard/api/mcp_ui_counter/v1/counter.py -->
...
From the `mcp-ui-counter` example:

<!-- MARKDOWN-AUTO-DOCS:START (CODE:src=../../../reboot/examples/mcp-ui-counter/api/mcp_ui_counter/v1/counter.py&lines=94-100&syntax=python) -->
<!-- The below code snippet is automatically added from ../../../reboot/examples/mcp-ui-counter/api/mcp_ui_counter/v1/counter.py -->
...
From the `mcp-ui-counter-dashboard` example:

<!-- MARKDOWN-AUTO-DOCS:START (CODE:src=../../../reboot/examples/mcp-ui-counter-dashboard/api/mcp_ui_counter/v1/counter.py&lines=97-104&syntax=python) -->
<!-- The below code snippet is automatically added from ../../../reboot/examples/mcp-ui-counter-dashboard/api/mcp_ui_counter/v1/counter.py -->
...
<!-- MARKDOWN-AUTO-DOCS:START (CODE:src=../../../reboot/examples/mcp-ui-counter/frontend/vite.config.ts&syntax=typescript) -->
<!-- The below code snippet is automatically added from ../../../reboot/examples/mcp-ui-counter/frontend/vite.config.ts -->
