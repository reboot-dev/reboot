...
A Reboot application can serve an MCP client — ChatGPT, Claude,
...
[`User`](/users/overview). Nothing about an MCP UI is a separate
kind of application.
...
<!-- MARKDOWN-AUTO-DOCS:START (CODE:src=../../../reboot/examples/mcp-ui-counter/api/mcp_ui_counter/v1/counter.py&lines=63-88&syntax=python) -->
