...
* different [data types](/learn_more/define/overview) on the backend
...
It includes:
* a reactive frontend
* multiple instances of the same [data type](/learn_more/define/overview)
* a simple [transaction](/learn_more/define/methods#kinds) that
...
* [optimistic updates](/learn_more/call/from_react#optimistic-updates): sent messages are
...
* many different [data types](/learn_more/define/overview) and API interactions
